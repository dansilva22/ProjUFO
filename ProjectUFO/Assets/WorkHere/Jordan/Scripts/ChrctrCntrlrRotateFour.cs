...
public class ChrctrCntrlrRotateFour : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        //Setting up axes
        float moveHorizontal = Input.GetAxisRaw("Player4_Horizontal");
        float moveVertical = Input.GetAxisRaw("Player4_Vertical");
